          ...
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              ...
              <table class="table table-bordered table-striped">
                ...
                <tbody>
                  <?php 
                    $sql1 = "SELECT * FROM shopperinfo";

                    $result1 = mysqli_query($conn,$sql1);

                    while($row = mysqli_fetch_array($result1)) {     
                      echo "<tr>";
                      echo "<td>".$row['shopperID']."</td>";
                      echo "<td>".$row['shopperFname']."</td>";
                      echo "<td>".$row['shopperSname']."</td>";
                      echo "<td>".$row['shopperUsername']."</td>";
                      echo "<td>".$row['shopperEmail']."</td>";
