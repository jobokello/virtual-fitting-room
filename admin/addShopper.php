...
<html lang="en">
        ...
        <div class="row">
          ...
          <div class="panel panel-default">
            <div class="panel-heading main-color-bg">
              <h3 style="text-align: center;" class="panel-title">Shopper Registration</h3>
            </div>
            <div class="panel-body">
               <br>
      

  <!--<h2>Shopper registration page</h2>-->

  <form action="../php/shopperReg.php" method="POST">
    <fieldset>
  ...
  <div class="form-group col-sm-4 col-md-4">
      ...
      <input list="mycounty" class="form-control" name="county" id="mycounty" required title="Enter your county of residence">
      <datalist id="mycounty">
