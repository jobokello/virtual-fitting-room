...
<html lang="en">
        ...
        <div class="row">
          ...
          <div class="panel panel-default">
            <div class="panel-heading main-color-bg">
              <h3 style="text-align: center;" class="panel-title">Designer Registration</h3>
            </div>
  ...
  <form action="../php/designerReg.php" method="POST">
    <fieldset>
      <legend style="text-align: center;">Designer registration page</legend>
